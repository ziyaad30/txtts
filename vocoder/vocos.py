...
from vocoder.feature_extractors import FeatureExtractor, EncodecFeatures
from vocoder.heads import FourierHead
from vocoder.models import Backbone
...
class Vocos(nn.Module):
    ...
    @classmethod
    def from_pretrained(self, model_path: str, config_path: str) -> "Vocos":
        """
        Class method to create a new Vocos model instance from a pre-trained model stored in the Hugging Face model hub.
        """
        # config_path = 'vocoder/config.yaml'
